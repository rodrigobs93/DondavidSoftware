...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Mensajes por defecto del validador, en español. Algunas reglas tienen
    | varias versiones (p. ej. las reglas de tamaño).
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado apareció en una filtración de datos. Por favor, elige otro.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Convención "atributo.regla" para mensajes específicos por campo y regla.
    |
    */

    'custom' => [
        'doc_number' => [
            'unique' => 'Ya existe un cliente con este número de identificación.',
        ],
        'name' => [
    ...
    |--------------------------------------------------------------------------
    |
    | Reemplaza el marcador :attribute por un nombre más legible en español.
    |
    */
    ...
    'attributes' => [
        ...
        'notes' => 'notas',
        'requires_fe' => 'factura electrónica',
        'active' => 'estado',
        'product_id' => 'producto',
        'price' => 'precio',
        'base_price' => 'precio',
